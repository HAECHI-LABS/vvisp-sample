...
module.exports = function(_contractAddr = '') {
  ...
  return {
    ...
    methods: {
      ...
      upgrade: function(_new_address, options) {
        const txData = contract.methods.upgrade(_new_address).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      setCompleted: function(_completed, options) {
        const txData = contract.methods.setCompleted(_completed).encodeABI();
        options = {
          ...options,
          data: txData
        };
